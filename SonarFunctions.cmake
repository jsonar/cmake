...
function(configure_post_install)
  cmake_parse_arguments(POST "KEEP_EXISTSING_VENV;ONLY_USE_REQUIREMENTS" "TARGET;TARGET_OUTPUT;PYTHON_VERSION;UNINSTALL_TARGET;UNINSTALL_TARGET_OUTPUT" "" ${ARGN})
  ...
  if (EXISTS "${POST_TARGET}")
    ...
    if(POST_KEEP_EXISTSING_VENV)
      set(KEEP_EXISTSING_VENV_VARIABLE "DONT_DELETE_EXISTING")
    endif()
    if(POST_ONLY_USE_REQUIREMENTS)
      set(ONLY_USE_REQUIREMENTS_VARIABLE "ONLY_USE_REQUIREMENTS")
    endif()
    create_venv(PYTHON_VERSION ${POST_PYTHON_VERSION} ${ONLY_USE_REQUIREMENTS_VARIABLE} ${KEEP_EXISTSING_VENV_VARIABLE})
