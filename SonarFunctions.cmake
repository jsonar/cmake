...
function(create_venv)
  ...
  cmake_parse_arguments(CREATE_VENV "DONT_DELETE_EXISTING;DONT_CREATE_PACKAGE" "PYTHON_VERSION" "" ${ARGN})
...
function(configure_post_install)
  cmake_parse_arguments(POST "DONT_DELETE_EXISTING;DONT_CREATE_PACKAGE" "TARGET;TARGET_OUTPUT;PYTHON_VERSION;UNINSTALL_TARGET;UNINSTALL_TARGET_OUTPUT" "" ${ARGN})
  if(NOT ${POST_TARGET_OUTPUT})
    set(POST_TARGET_OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/post)
  endif()
  if(${POST_UNINSTALL_TARGET_OUTPUT})
    configure_post_uninstall(TARGET ${UNINSTALL_TARGET} TARGET_OUTPUT ${UNINSTALL_TARGET_OUTPUT})
  endif()
  ...
  if (EXISTS "${POST_TARGET}")
    ...
    if(POST_DONT_DELETE_EXISTING)
      set(DONT_DELETE_EXISTING_VARIABLE "DONT_DELETE_EXISTING")
    endif()
    if(POST_DONT_CREATE_PACKAGE)
      set(DONT_CREATE_PACKAGE_VARIABLE "DONT_CREATE_PACKAGE")
    endif()
    create_venv(PYTHON_VERSION ${POST_PYTHON_VERSION} ${DONT_CREATE_PACKAGE_VARIABLE} ${DONT_DELETE_EXISTING_VARIABLE})
