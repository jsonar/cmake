...
function(create_venv)
  ...
  if(${CREATE_VENV_DONT_CREATE_PACKAGE})
    message("Not creating a package, using requirments file specified in \${REQUIREMENTS_PATH}")
  endif()
...
function(configure_post_install)
  ...
  if (EXISTS "${POST_TARGET}")
    ...
    if(POST_DONT_DELETE_EXISTING)
      create_venv(PYTHON_VERSION ${POST_PYTHON_VERSION} DONT_CREATE_PACKAGE ${POST_DONT_CREATE_PACKAGE} DONT_DELETE_EXISTING)
    else()
      create_venv(PYTHON_VERSION ${POST_PYTHON_VERSION} DONT_CREATE_PACKAGE ${POST_DONT_CREATE_PACKAGE})
    endif()
