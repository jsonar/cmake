...
function(add_compiler_option flag)
  include(CheckCXXCompilerFlag)
  set(CMAKE_REQUIRED_QUIET ON)
  cmake_parse_arguments(PARSE_ARGV 1 COMPILER_OPTION "VERBOSE;REQUIRED" "" "")
  if(COMPILER_OPTION_VERBOSE)
    set(quiet FALSE)
  else()
    set(quiet TRUE)
  endif()
  set(CMAKE_REQUIRED_LIBRARIES ${flag}) # -fsanizite=X is needed in linkage as well
  set(CMAKE_REQUIRED_QUIET ${quiet})
  check_cxx_compiler_flag("${flag}" has_flag_${flag})
  if(has_flag_${flag})
    message(STATUS "Adding compiler flag   ${flag}")
    target_compile_options(base PUBLIC ${flag})
  else()
    set(message "Skipping compiler flag ${flag} (not supported)")
