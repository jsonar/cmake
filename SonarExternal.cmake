...
function(build_aws)
  ...
  if (NOT AWS_VERSION)
    set(AWS_VERSION 1.11.271)
  endif()
  if(AWS_VERSION VERSION_GREATER_EQUAL 1.9.0)
    list(APPEND deps crt-cpp c-s3 c-auth c-http c-io c-compression c-cal c-mqtt c-sdkutils)
  endif()
...
function(build_boost)
  ...
  if (BOOST_SOURCE_DIR)
    ...
    set(download_step URL
      https://archives.boost.io/release/${BOOST_VERSION}/source/boost_${BOOST_VERSION_UNDERSCORES}.tar.bz2	    
...
function(build_libxml2)
  ...
  if (NOT LIBXML2_VERSION)
    ...
    set(LIBXML2_SHA256 0805d7c180cf09caad71666c7a458a74f041561a532902454da5047d83948138)
  endif()
...
function(build_aws_encryption)
  ...
  if (NOT AWS_ENCRYPTION_VERSION)
    set(AWS_ENCRYPTION_VERSION 2.4.0)
  endif()
...
function(build_unixodbc)
  ...
  if (NOT UNIXODBC_VERSION)
    set(UNIXODBC_VERSION 2.3.12)
    set(UNIXODBC_MD5 d62167d85bcb459c200c0e4b5a63ee48)
  endif()
