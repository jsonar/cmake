...
function(build_pcre)
  ...
  ExternalProject_Add(pcre
    URL https://cfhcable.dl.sourceforge.net/project/pcre/pcre/${PCRE_VERSION}/pcre-${PCRE_VERSION}.tar.bz2
    DOWNLOAD_NO_PROGRESS 1
...
function(build_bzip2_shared)
  if(TARGET bzip2-shared)
    external_project_dirs(bzip2-shared install_dir)
    return()
  endif()
  cmake_parse_arguments(BZIP2_SHARED "" "VERSION" "" ${ARGN})
  if (NOT BZIP2_SHARED_VERSION)
